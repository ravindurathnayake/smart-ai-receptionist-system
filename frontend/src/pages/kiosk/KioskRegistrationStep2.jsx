...
const SideNav = () => {
    const regSteps = [
        ...
        { icon: 'medical_services', label: 'Symptoms', active: true },
    ...
    <header className="flex justify-between items-center w-full px-10 h-16 bg-white border-b border-outline-variant/10 shadow-[0_4px_20px_rgba(0,71,141,0.04)] z-30 shrink-0 font-headline">
        <div className="flex items-center gap-3">
            ...
            <div>
                ...
                <p className="text-xs text-on-surface-variant font-medium font-body leading-none">Step 2 of 4: Symptoms Assessment</p>
            </div>
        </div>
                ...
                <div className="flex-1 flex flex-col items-center p-10 overflow-hidden">
                    <div className="max-w-5xl w-full flex flex-col h-full z-10">
                        ...
                        <div className="grid grid-cols-3 gap-6 mb-8 shrink-0">
                            {categories.map((cat) => (
                                <button
                                    ...
                                    className={`symptom-card p-6 rounded-[2rem] flex flex-col items-center text-center gap-4 ${
                                        selectedCategory === cat.id ? 'symptom-card-active' : ''
                        ...
                        <div className="flex justify-between items-center bg-white/40 backdrop-blur-md p-6 rounded-[2rem] border border-white/50 shadow-sm shrink-0">
                            <button className="btn-kiosk-action flex items-center gap-2 bg-slate-100 text-slate-700 rounded-full px-10 py-4 font-bold text-lg hover:bg-slate-200 transition-all">
                                <span className="material-symbols-outlined">arrow_back</span>
                                Back
                            </button>
                            <div className="flex gap-4">
                                <button className="font-bold text-slate-500 hover:text-primary px-6 py-4 transition-colors">
                                    Skip for Now
                                </button>
                                <button className="btn-kiosk-action flex items-center gap-2 bg-primary text-white rounded-full px-12 py-4 shadow-xl shadow-primary/20 font-bold text-lg hover:scale-105 active:scale-95 transition-all">
                                    Next Step
