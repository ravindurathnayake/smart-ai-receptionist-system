...
const SideNav = () => {
  const regSteps = [
    { icon: 'person', label: 'Basic Info', active: true },
    ...
    <header className="flex justify-between items-center w-full px-10 h-16 bg-white border-b border-outline-variant/10 shadow-[0_4px_20px_rgba(0,71,141,0.04)] z-30 shrink-0 font-headline">
        <div className="flex items-center gap-3">
            ...
            <div>
                ...
                <p className="text-xs text-on-surface-variant font-medium font-body leading-none">Step 1 of 4: Basic Information</p>
            </div>
        </div>
          ...
          <div className="max-w-4xl w-full flex flex-col h-full z-10">
            ...
            <div className="glass-card flex-1 rounded-[2.5rem] p-10 border border-outline-variant/10 shadow-[0_12px_40px_rgba(0,71,141,0.06)] relative overflow-hidden flex flex-col justify-between min-h-0">
                    ...
                    {['Male', 'Female', 'Other'].map((g) => (
                      <button
                        ...
                        className={`py-3 rounded-2xl font-bold transition-all flex items-center justify-center gap-2 ${
                          gender === g ? 'btn-toggle-active' : 'btn-toggle-inactive'
                        }`}
                      >
              ...
              <div className="mt-8 flex items-center justify-between shrink-0">
                ...
                <button className="bg-gradient-to-br from-primary to-primary-container text-white px-10 py-4 rounded-full font-bold text-lg shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-transform flex items-center gap-2">
                  Next Step
