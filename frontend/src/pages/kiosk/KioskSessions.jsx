...
const SideNav = () => {
    const navItems = [
        ...
        { icon: 'calendar_month',  label: 'Book Appointment',     active: true  },
            ...
            <nav className="flex-1 flex flex-col px-3 mt-4 gap-1">
                {navItems.map(({ icon, label, active }) => (
                    <a
                        key={label}
                        href="#"
                        className={`flex items-center gap-4 px-5 py-3 rounded-xl transition-all font-semibold text-sm ${
        ...
        <div className="flex items-center gap-5">
            ...
            <div className="flex items-center gap-3 bg-slate-50 px-4 py-2 rounded-full border border-slate-100">
                <div className="text-right">
                    ...
                    <p className="text-[10px] font-semibold text-slate-500 uppercase tracking-wider mt-0.5">Patient • ID #8829-LH</p>
                </div>
                <img
                    alt="User profile"
                    className="w-9 h-9 rounded-full object-cover ring-2 ring-white shadow-sm"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuD2pvCWI05-9iR24k6UkpR2P4AAKdpiy-K1SuWsxwoe5MQ_Qlh9_DWMHyal-KohH65F3ptH6TxD86lsv70pjXg4gNvLY7xa3CPCNw87eOe3pfX_J6YrQBUzoPIHzBZVExDNNUeYnLAu_DaBTcCMsqFWn1K257mO1FoGZ4OqOYvYmbG_t0uiYJ50ZDwULkjduTxZsLOjve_T_Opi1a_R50efOY47hHqs-hYOuxzX8Spbs7dlKij4rq3rIcisdFE8jcDBmBE36SB1zYA"
                />
            </div>
        </div>
    </header>
...
const SessionPanel = ({ selectedDate, onDateSelect, selectedSlot, onSlotSelect }) => (
    <div className="flex-1 bg-white flex flex-col overflow-hidden relative">
        ...
        <div className="shrink-0 bg-white/90 backdrop-blur-md border-t border-slate-100 px-8 py-4 z-10">
            ...
            <div className="flex items-center gap-3">
                <button className="flex-1 py-3.5 px-6 bg-surface-container-highest text-on-surface-variant rounded-full font-bold text-sm hover:bg-slate-200 transition-all">
                    ← Back to Search
                </button>
                <button
...
const AIFloatingBtn = () => (
    <div className="ai-fab-wrapper" style={{ position: 'fixed', bottom: '2rem', right: '2rem', zIndex: 60 }}>
        ...
        <button className="ai-fab-sq ai-pulse" aria-label="Open AI Assistant">
