...
const TopBar = () => (
    <header className="flex justify-between items-center w-full px-10 h-16 bg-white border-b border-outline-variant/20 z-30 shrink-0">
        <div className="flex items-center gap-3">
            ...
            <div>
                <h1 className="text-xl font-extrabold tracking-tight text-primary font-headline leading-tight">
                    Verification Hub
                </h1>
                <p className="text-xs text-on-surface-variant font-medium leading-none">Patient Identification Centre</p>
            </div>
        </div>
                    ...
                    <div className="flex-1 flex flex-col min-h-0 max-w-3xl w-full mx-auto">
                        ...
                        {!submitted && (
                            <div className="shrink-0 flex items-center justify-between p-5 mt-4 bg-surface-container-lowest rounded-2xl shadow-sm border border-slate-100">
                                ...
                                <button className="assist-btn px-6 py-3 border-2 border-primary/20 text-primary font-bold rounded-full text-sm">
                                    Get Assistance
                                </button>
                            </div>
                        )}
